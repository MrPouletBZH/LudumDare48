...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
                ...
                .OnComplete(
                    operation =>
                    {
                        ...
                        if(CheckDuplicateBindings(action, bindingIndex, allCompositeParts)){
                            m_DuplicateWarning.text = "This key is already use for something else!";
                            action.RemoveBindingOverride(bindingIndex);
                            CleanUp();
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts = false){
            ...
            if(allCompositeParts){
                for (int i = 1; i<bindingIndex; i++) {
                    if (action.bindings[i].effectivePath == newBind.effectivePath){ 
                        Debug.Log("Duplicate:" +  newBind.effectivePath);
                        return true;
                    }
                }
        ...
        private Text m_DuplicateWarning;
        ...
        private void Start() {
            UpdateActionLabel();
            UpdateBindingDisplay();
            m_DuplicateWarning = GameObject.FindGameObjectWithTag("DuplicateWarning").GetComponent<Text>();
            m_DuplicateWarning.text = "";
        }
